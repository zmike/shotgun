...
void
contact_list_user_del(Contact_List *cl, Contact *c, Shotgun_Event_Presence *ev)
{
   Eina_List *l;
...
contact_list_new(void)
{
   ...
   evas_object_smart_callback_add(btn, "clicked", (Evas_Smart_Cb)chat_window_close_cb, win);
