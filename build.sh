...
CF="-DHAVE_LIMITS_H -DSTDC_HEADERS -DHAVE_MEMCPY=1 -DVREV=\"$VREV\" -I$(readlink -f .) -D_GNU_SOURCE=1 -O0 -pipe -Wall -Wextra -g -I$(readlink -f src/include) -DHAVE_ECORE_X -DHAVE_DBUS -DPACKAGE_DATA_DIR=\".\""
[[ -z "$CC" ]] && CC=gcc
[[ -z "$CXX" ]] && CXX=g++
